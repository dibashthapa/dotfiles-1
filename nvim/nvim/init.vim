...
Plug 'arcticicestudio/nord-vim'                                          " Primary   | Nord Vim                     | Vim nord colors
Plug 'skammer/vim-css-color'                                             " Primary   | CSS Color                    | Shows colors visually
Plug 'dracula/vim'                                                       " Primary   | Dracula Vim                  | Vim dracula colors
Plug 'morhetz/gruvbox'                                                   " Primary   | Gruvbox                      | Vim gruvbox colors
Plug 'sonph/onehalf', { 'rtp': 'vim' }                                   " Primary   | OneHalf                      | Vim onehalf colors
Plug 'joshdick/onedark.vim'                                              " Primary   | Onedark                      | Vim 
Plug 'iamcco/markdown-preview.nvim', { 'do': 'cd app && yarn install'  } " Primary   | Markdown Preview             | Live server preview for Markdown
call plug#end()
...
colorscheme nord        " Vim colors

" Install new plugins pressing F10
nnoremap <C-F10> :PlugInstall<CR>         
" Update current plugins pressing F9
nnoremap <C-F9> :PlugUpdate<CR>           
